...
class CounterActivityRenderer @Inject constructor(
    ...
    override fun uiActions(): List<UIAction<CounterActivityUIState, UIAction.UIActionData>> {
        return listOfNotNull(
                counterClickUIAction as? UIAction<CounterActivityUIState, UIAction.UIActionData>
        )
    }
}
